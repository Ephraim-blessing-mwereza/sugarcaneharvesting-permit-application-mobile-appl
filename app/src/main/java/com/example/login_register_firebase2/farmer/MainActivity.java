...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView navDrawerIcon = findViewById(R.id.toolbar_logo);
                    ...
                    .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                        ...
                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                            ...
                            if (profilePictureUrl != null) {
                                ...
                                Glide.with(MainActivity.this).load(profilePictureUrl).into(navHeaderImage);
                            }
                        }
                    });
        }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_apply_permit) {
            Intent intent = new Intent(MainActivity.this, ApplyPermit.class);
            startActivity(intent);
            return true;
        }

        if (id == R.id.nav_issued_permit){
            Intent intent = new Intent(MainActivity.this, IssuedPermit.class);
            startActivity(intent);
            return true;
        }
